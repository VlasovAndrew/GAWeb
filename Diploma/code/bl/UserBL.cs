...
{
    // ”ровень бизнес-логики.
    // –еализут работу с пользовател€ми.
    public class UserBL : IUserBL
    {
        // ссылка на модуль дл€ работы с пользователем
        private readonly IUserDao _userDao;
        // ссылка на модуль дл€ работы с хешированим паролей
        ...
        // ƒобавление нового пользовател€ с шифрацией парол€
        ...
        // ѕроверка парол€ по логину пользовател€
        public bool CheckPassword(LoginUserRequest user)
        {
            // поиск пользовател€ по логину
        ...
        // ѕроверка существует ли пользователь с переданным логином
